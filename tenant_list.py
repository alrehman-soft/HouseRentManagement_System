...
def open_tenant_list():
    ...
    def open_edit_window(tenant):
            ...
            tk.Button(button_frame, text="UPDATE",
                    bg="#31726C", fg="white", width=15, height=1, font=("Segoe UI", 12, "bold"),cursor="hand2", bd=0,
                    command=update_tenant).pack(side=tk.LEFT, padx=10)

            # ========== CANCEL BUTTON ADDED ==========
            tk.Button(button_frame, text=" CANCEL",
                    bg="#1A1919", fg="white", width=15, height=1, font=("Segoe UI", 12, "bold"),cursor="hand2", bd=0,
